...
def dapatkan_nama(cookie, token_eaag):
    with requests.Session() as r:
        r.headers.update({
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 11.0.1; H3 Build/RP1A.173794.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4315.53 Mobile Safari/537.36 [Line/38.4.1/IAB;]',
            'cookie': cookie
        })
    ...
    def pengikut(self, userid, cookie, token_eaag):
        try:
            with requests.Session() as r:
                r.headers.update({
                    'host': 'graph.facebook.com',
                    'user-agent': 'Mozilla/5.0 (Linux; Android 11.0.1; H3 Build/RP1A.173794.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.71 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/375.1.0.28.111;]',
                    'cookie': cookie
                })
